...
if ($agent_screen_colors != 'default')
	...
	$rslt=mysql_to_mysqli($stmt, $link);
		if ($mel > 0) {mysql_error_logging($NOW_TIME,$link,$mel,$stmt,$script_name,'01XXX',$VD_login,$server_ip,$session_name,$one_mysql_log);}
	if ($DB) {echo "$stmt\n";}
	$qm_conf_ct = mysqli_num_rows($rslt);
	if ($qm_conf_ct > 0)
		{
...
echo "<TR><TD ALIGN=CENTER COLSPAN=2><font size=1> &nbsp; </TR>\n";
